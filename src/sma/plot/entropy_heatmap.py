...
def entropy_heatmap(
    np_img, img_idx, width=3.5, height=3.292, output_format="pdf", verbose=False
):
    """
    ...
    :type img_idx: int
    :param width: Width of the plot (default: 3.5).
    :type width: float
    :param height: Height of the plot (default: 3.292).
    :type height: float
