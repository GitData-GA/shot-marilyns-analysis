...
\begin{figure}[ht]
  ...
  \begin{minipage}{0.6\textwidth}
    ...
    \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=125px]{main_files/figure-latex/3_5_sageblue_marilyn_entropy.pdf}
      \caption{Sage blue Marilyn Relative Conditional Entropy}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.24\textwidth}
    ...
    \caption{315 \degree azimuth}
    \label{fig:4_4_orange_marilyn_original_scatter}
  \end{subfigure}
  \caption{Orange Marilyn's RGB space occupied by the pixels for the entire image with 30 \degree elevation and 4 different azimuth angles}
  \label{fig:orange_marilyn_original_scatter}
\end{figure}

Figure \ref{fig:orange_marilyn_original_scatter} displays the RGB space of "Orange Marilyn" from four
...
In \ref{fig:4_2_orange_marilyn_original_scatter}, the plot illustrates how colors are distributed from darker
...
In \ref{fig:4_3_orange_marilyn_original_scatter}, the concentration of the brightest pixels is evident, showing
...
In \ref{fig:4_4_orange_marilyn_original_scatter}, the color distribution from dark to light is presented from a
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Red Marilyn's RGB space occupied by the pixels for the entire image with 30 \degree elevation and 4 different azimuth angles}
  \label{fig:red_marilyn_original_scatter}
\end{figure}

Figure \ref{fig:red_marilyn_original_scatter} displays the RGB space of "Red Marilyn" from four different
...
In \ref{fig:4_5_red_marilyn_original_scatter}, the colors and shape of the figure is similar to the
...
The shapes in \ref{fig:4_6_red_marilyn_original_scatter} through \ref{fig:4_8_red_marilyn_original_scatter} all reflect a similar elongated form as
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Turquoise Marilyn's RGB space occupied by the pixels for the entire image with 30 \degree elevation and 4 different azimuth angles}
  \label{fig:turq_marilyn_original_scatter}
\end{figure}

Figure \ref{fig:turq_marilyn_original_scatter} displays the RGB space of "Turquoise Marilyn" from four
...
Unlike the previous two portraits, the shape image \ref{fig:4_9_turq_marilyn_original_scatter} for "Turquoise
Marilyn" lacks a prominent amount of orange color, creating an upside
down "V" shape.

Image \ref{fig:4_10_turq_marilyn_original_scatter} through \ref{fig:4_12_turq_marilyn_original_scatter} are similar to the previous "Shot Marilyns,"
just with lighter shades of color. The wide shapes for each one resemble
"Red Marilyn."

The shapes in \ref{fig:4_9_turq_marilyn_original_scatter} through \ref{fig:4_12_turq_marilyn_original_scatter} reflect a similar elongated form,
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Blue Marilyn's RGB space occupied by the pixels for the entire image with 30 \degree elevation and 4 different azimuth angles}
  \label{fig:blue_marilyn_original_scatter}
\end{figure}

Figure \ref{fig:blue_marilyn_original_scatter} displays the RGB space of "Blue Marilyn" from four different
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Sage blue Marilyn's RGB space occupied by the pixels for the entire image with 30 \degree elevation and 4 different azimuth angles}
  \label{fig:sageblue_marilyn_original_scatter}
\end{figure}

Figure \ref{fig:sageblue_marilyn_original_scatter} displays the RGB space of "Sage blue Marilyn" from four
...
In \ref{fig:4_17_sageblue_marilyn_original_scatter}, the pixels are closer together, creating a smaller shape. There
are also small vibrant pixels of white on the top of the shape,
representing Marilyn's teeth.

The funnel shape in image \ref{fig:4_18_sageblue_marilyn_original_scatter} is relatively narrow, especially when
compared to "Red Marilyn." This shows how subdued the colors are when
compared to the previous portraits.

In \ref{fig:4_19_sageblue_marilyn_original_scatter}, the plot emphasizes the concentration of the brightest pixels,
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{main_files/lucid-chart/roi_matrix.jpeg}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.19\textwidth}
        ...
        \caption{Orange Marilyn}
        \label{fig:7_1_orange_marilyn_background_extraction}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/8_1_red_marilyn_background_extraction.jpg}
        \caption{Red Marilyn}
        \label{fig:8_1_red_marilyn_background_extraction}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/9_1_turq_marilyn_background_extraction.jpg}
        \caption{Turquoise Marilyn}
        \label{fig:9_1_turq_marilyn_background_extraction}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/10_1_blue_marilyn_background_extraction.jpg}
        \caption{Blue Marilyn}
        \label{fig:10_1_blue_marilyn_background_extraction}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/11_1_sageblue_marilyn_background_extraction.jpg}
        \caption{Sage blue Marilyn}
        \label{fig:11_1_sageblue_marilyn_background_extraction}
    \end{subfigure}
    \caption{Region of Interest (ROI) - Backgrounds}
    \label{fig:marilyn_background_extraction}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/11_2_sageblue_marilyn_hair_extraction.jpg}
        \caption*{e) Sage blue Marilyn}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/11_3_sageblue_marilyn_eyeshadow_extraction.jpg}
        \caption*{e) Sage blue Marilyn}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \hfill
    \begin{subfigure}[b]{0.19\textwidth}
        \includegraphics[width=\textwidth]{main_files/figure-latex/11_4_sageblue_marilyn_face_extraction.jpg}
        \caption*{e) Sage blue Marilyn}
    \end{subfigure}
