...
Figure~\ref{fig:all_marilyn_original_scatter} illustrates how Andy Warhol employed color to create depth and contrast across the “Shot Marilyn” series. In the scatter plots for Orange Marilyn (a) - (d), we observe a broad distribution of colors corresponding to the orange background, yellow hair, pink face, red lips, and blue eye shadows. The elongated shapes indicate a gradient from dark to light colors, reflecting Warhol’s diverse use of color in the background and facial features.

The plots for Red Marilyn (e) - (h) are similar but show a greater prominence of orange and brighter shades of yellow and blue. The shapes are more spread out, resembling a long, thick funnel, suggesting that the colors are brighter and more impactful than in Orange Marilyn. Warhol’s use of vivid hues draws attention to specific features in this portrait.

For Turquoise Marilyn (i) - (l), the scatter plots differ by lacking a significant amount of orange, forming an upside-down “V” shape. The turquoise background and the brightest shades of Marilyn’s hair, skin, and eye shadow among all five portraits are evident. The wide shapes in the plots highlight the brighter colors used, similar to Red Marilyn.

In the case of Blue Marilyn (m) - (p), the plots display smaller shapes akin to Orange Marilyn, but with colors that are less spread out and darker. The blue background and the darker tones of Marilyn’s hair and skin set this portrait apart. The compact distribution indicates a more subdued palette.

Finally, the plots for Sage Blue Marilyn (q) - (t) show the darkest colors among the five portraits. The pixels are closer together, creating smaller shapes. The narrow funnel shape emphasizes the subdued colors compared to the previous portraits. Notably, small clusters of bright white pixels represent Marilyn’s teeth, standing out against the darker hues.
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{\textwidth}
    ...
    \caption{Orange Marilyn}
    \label{fig:6_1_orange_marilyn_color_ribbon}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{main_files/figure-latex/6_2_red_marilyn_color_ribbon.pdf}
    \caption{Red Marilyn}
    \label{fig:6_2_red_marilyn_color_ribbon}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{main_files/figure-latex/6_3_turq_marilyn_color_ribbon.pdf}
    \caption{Turquoise Marilyn}
    \label{fig:6_3_turq_marilyn_color_ribbon}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
     \centering
     \includegraphics[width=\textwidth]{main_files/figure-latex/6_4_blue_marilyn_color_ribbon.pdf}
     \caption{Blue Marilyn}
     \label{fig:6_4_blue_marilyn_color_ribbon}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[width=\textwidth]{main_files/figure-latex/6_5_sageblue_marilyn_color_ribbon.pdf}
      \caption{Sage blue Marilyn}
      \label{fig:6_5_sageblue_marilyn_color_ribbon}
  \end{subfigure}
  \caption{Clustered Color Ribbons Depicting Dominant Color Distribution Across Warhol's "Shot Marilyns"}
  \label{fig:marilyn_color_ribbon}
\end{figure}

Figure \ref{fig:marilyn_color_ribbon} presents the clustered ribbons for each of the five Marilyn
...
In the Orange Marilyn image \ref{fig:6_1_orange_marilyn_color_ribbon}, the ribbon is dominated by a large
...
The Red Marilyn image \ref{fig:6_2_red_marilyn_color_ribbon} shows a prominent red section, emphasizing the
...
In the Turquoise Marilyn image \ref{fig:6_3_turq_marilyn_color_ribbon}, the ribbon displays a more varied
...
The Blue Marilyn image \ref{fig:6_4_blue_marilyn_color_ribbon} is dominated by a large blue section,
...
Finally, the Egg Blue Marilyn image \ref{fig:6_5_sageblue_marilyn_color_ribbon} shows a harmonious distribution
...
them apart from the others. Sage Blue Marilyn, with its more subdued and
